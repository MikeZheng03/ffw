...
(function(h){var c={options:{curPage:0,totalPages:0,totalRecords:0,msg:"",rPPOptions:[3,20,30,40,50,100],rPP:3},_regional:{strDisplay:"Displaying {0} to {1} of {2} items.",strFirstPage:"First Page",strLastPage:"Last Page",strNextPage:"Next Page",strPage:"Page {0} of {1}",strPrevPage:"Previous Page",strRefresh:"Refresh",strRpp:"Records per page:{0}"}};h.extend(c.options,c._regional);c._create=function(){var c=this,p=this.options;this.element.addClass("pq-pager");this.first=h("<button type='button' title='"+
