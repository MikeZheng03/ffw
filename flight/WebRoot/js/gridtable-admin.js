$(function () {
		...
		window.drawRouteButtonClick = function (target) {
            ...
            var index = $tdUserName.text() + $tdPlanNum.text();
		...
		window.addApplicationStatusRow = function (jsonData) {
			...
			for(var i = 0; i < jsonData.length; i++) {
				var index = jsonData[i].userName + jsonData[i].planNum;
        ...
        var colM = [
            { title: "用户名", width: 100, dataType: "string", dataIndx: "userName", render: filterRender },
