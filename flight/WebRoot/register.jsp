...
<script>
 	function checkf(){
		...
		if(f.username.value==""){
		  ...
		  return false;
			...
			var regExp = /^[a-z0-9]+$/i;
			if(!regExp.test(f.username.value)) {
				alert('用户名必须由字母和数字组成');
				return false;
			} else if(f.username.value.length > 15) {
				alert('用户名不得超过15个字符');
				return false;
			}
		}
	...
	function submitInfo() {
		...
		var urlString = "submitinfo.jsp?requestType=register";
		$.ajax({
			type:"POST",
			url: urlString,
			async: true,
...
<table width="100%" height="600" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
	...
	<form id="form1" name="form1" method="post" action="" onsubmit="return checkf();">
      ...
      <tr>
        ...
        <td width="500" align="center" valign="middle" ><table width="100%" height="403" border="0" cellpadding="0" cellspacing="0">
          <tr bordercolor="#185089">
            <td height="22" colspan="4" align="left" style="border-bottom:solid #8BA9C5 2px"><span class="STYLE8"><img src="img/yh.gif" width="76" height="22" /></span></td>
            </tr>
          <tr>
          ...
          <tr>
            ...
            <td align="left"><span class="STYLE11" id="username_result">*15位英文或数字</span></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td align="left"><span class="STYLE11">*请输入密码</span></td>
          </tr>
          <tr>
            ...
            <td align="left"><span class="STYLE11">*请再输入一遍</span></td>
          </tr>
          <tr>
            ...
            <td align="left"><span class="STYLE11">*注册结果，邮件告知</span></td>
          </tr>
		  <tr>
          ...
          <tr>
            ...
            <td align="left" valign="middle">
				<input name="image" type="button"  style="width:58px; height:33px; font-size:20px" value="注册" onclick="submitInfo()"></input>
			</td>
          </tr>
        </table></td>
