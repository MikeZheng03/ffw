...
<body>
<table width="100%" height="100%" border="0" align="center" cellpadding="0" cellspacing="0"  style="margin:0px; padding:0px">
  <tr>
	...
	<table width="465" height="414" border="0" align="center" cellpadding="0" cellspacing="0" >
      ...
      <tr>
		...
		<form id="form1" name="form1" method="post" action="LoginAction.action" onsubmit="return check();">
		<table width="100%" height="170" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
              ...
              <td width="20%" align="right" valign="middle"><a href="register.jsp"><span class="STYLE4">注册新用户</span></a><br />
                  <br />
<a href="forgetpsw.jsp"><span class="STYLE4">找回密码</span></td>
